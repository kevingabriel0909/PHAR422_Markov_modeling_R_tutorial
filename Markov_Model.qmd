...
p_UD <-  # probability of dying when Unhealthy
```
...
## State rewards
## Costs
c_H = , # annual cost of being Healthy (excluding any treatment cost)
c_U = , # annual cost of being Unhealthy (excluding any treatment cost)
c_D = , # annual cost of being Dead
c_trt = , # annual cost of the new treatment (T1), applies while a patient remains alive and on treatment
